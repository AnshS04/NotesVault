                        ...
                        <div className="modal-body">
                            <form className='my-3'>
                                <div className="form-group my-1">
                                    ...
                                    <input type="text" className="form-control" id="etitle" name='etitle' value={note.etitle} aria-describedby="emailHelp" onChange={onChange} placeholder="Enter title" minLength={5} required />
                                </div>
                                <div className="form-group my-1">
