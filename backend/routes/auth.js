...
const JWT_SECRET = 'wsupNibba@';

// Route1: create a user using: post "/api/auth"/ , it doesnt require auth
...
// Route 3: gettin user details using post: "api/auth/getuser", login required
